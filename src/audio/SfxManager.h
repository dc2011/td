...
#define PLAY_LOCAL_NOTIFICATION(x)  AudioManager::instance()->playSfx(x, ntf)
#define PLAY_SFX(x, y)              SfxManager::makeSfxNetworkMsg(x, y)
#define PLAY_NOTIFICATON(x, y)      SfxManager::makeSfxNetworkMsg(x, y, ntf)
 ...
 * @code
 *  PLAY_LOCAL_NOTIFICATION(SfxManager::towerBuildingStarted);
 * @endcode
 * 
 ...
 * @code
 *  PLAY_NOTIFICATION(tower_, SfxManager::towerBuildingStarted);
 * @endcode
 *
 * @author Dean Morin
 */
